...
namespace DecoratorExample.Example3
{
    ...
    public class StoreGetAllQueryHandler : IQueryHandler<UnitQuery, IEnumerable<StoreModel>>
    {
    ...
    public class MiddlewareFirst : Middleware<UnitQuery, IEnumerable<StoreModel>>
    {
        public MiddlewareFirst(
            IEnumerable<IMiddleware<UnitQuery, IEnumerable<StoreModel>>> middlewareItems
        ) : base(middlewareItems)
        {
        }

        public override UnitQuery BeforeNext(UnitQuery input)
        {
            return input;
        }

        public override IEnumerable<StoreModel> AfterNext(IEnumerable<StoreModel> prevResult)
        {
            return prevResult;
        }
    }

    public class MiddlewareSecond : Middleware<UnitQuery, IEnumerable<StoreModel>>
    {
        public MiddlewareSecond(
            IEnumerable<IMiddleware<UnitQuery, IEnumerable<StoreModel>>> middlewareItems
        ) : base(middlewareItems)
        {
        }
